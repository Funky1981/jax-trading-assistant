...
// MemoryClientAdapter adapts UTCP MemoryService to app.MemoryClient interface
...
// Agent0ClientAdapter adapts agent0.Client to app.Agent0Client interface
...
// DexterClientAdapter adapts dexter.Client to app.DexterClient interface
...
func (t *ToolRunnerImpl) Execute(ctx context.Context, plan app.PlanResult) ([]app.ToolRun, error) {
