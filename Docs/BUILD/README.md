...
The roadmap and product status remain authoritative for sequencing and maturity. This directory routes implementation detail only; it cannot authorize a new paper run, formal evidence, or live execution.
