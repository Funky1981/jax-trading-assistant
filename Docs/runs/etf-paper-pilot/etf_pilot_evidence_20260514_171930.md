...
- status: blocked
- generated: 2026-05-14T16:19:34.2619758Z
- api_base: http://localhost:8181
- pilot_symbol: SPY
- excluded_symbol: TQQQ

## Checks
- [PASS] etf/catalog: http://localhost:8181/api/v1/instruments/etfs
- [PASS] etf/pilot-status: http://localhost:8181/api/v1/trading/pilot-status
- [PASS] etf/testing-readiness: http://localhost:8181/api/v1/testing/readiness
...
- [FAIL] pilot/workflow: expected candidate_approval_only, got approval_only
