...
Paper trading in this repository is hypothetical and evidence-bounded. A paper ticket is not an order, an execution instruction, a fill, or proof of edge.
...
- `PAPER_TRADING_DECISION_GATE.md` — compatibility pointer for the current gate.

No document in this directory authorizes a pilot or live trading. Authorization comes only from the external decision recorded against `Docs/ROADMAP.md` and `Docs/DOCUMENTATION-AUTHORITY.md`.
