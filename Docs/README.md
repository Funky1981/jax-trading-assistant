...
This folder contains the numbered build plan docs for Codex.
...
- `docs/` — numbered step-by-step build documents (what Codex follows)
- `templates/` — copy/paste snippets (schemas, example payloads)
- `checklists/` — “definition of done” for each step
