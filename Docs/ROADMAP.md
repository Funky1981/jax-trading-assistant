...
| Current implementation package | **WP-08.06 — Critic/reflection stage** |
| Next package | **WP-08.06 — Critic/reflection stage** |
...
package is `WP-08.06 — Critic/reflection stage`. Do not begin Phase 09
