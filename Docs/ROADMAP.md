...
| Current implementation package | **WP-08.05 — Adaptive gap-finding/replanning** |
| Next package | **WP-08.05 — Adaptive gap-finding/replanning** |
...
package is `WP-08.05 — Adaptive gap-finding/replanning`. Do not begin Phase 09
