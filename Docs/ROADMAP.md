...
| Current implementation package | **WP-08.04 — Durable research task/checkpoint state** |
| Next package | **WP-08.04 — Durable research task/checkpoint state** |
...
package is `WP-08.04 — Durable research task/checkpoint state`. Do not begin Phase 09
